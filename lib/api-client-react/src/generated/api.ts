 ...
 */
export const getApiInfo = async ( options?: Parameters<typeof customFetch>[1]): Promise<ApiInfo> => {

  return customFetch<ApiInfo>(getGetApiInfoUrl(),
  {
    ...options,
    method: 'GET'
...
export const getGetApiInfoQueryOptions = <TData = Awaited<ReturnType<typeof getApiInfo>>, TError = ErrorType<unknown>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getApiInfo>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetApiInfoQueryKey();
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getApiInfo>>> = ({ signal }) => getApiInfo({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getApiInfo>>, TError, TData> & { queryKey: QueryKey }
}

export type GetApiInfoQueryResult = NonNullable<Awaited<ReturnType<typeof getApiInfo>>>
export type GetApiInfoQueryError = ErrorType<unknown>
...
export function useGetApiInfo<TData = Awaited<ReturnType<typeof getApiInfo>>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getApiInfo>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
